...
Graph::Graph(bool weighted, int numVertices, unsigned long seed)
    :weighted(weighted),
     ...
     random(Random(seed)) 
{
    if (numVertices < 2) //checks to see that the number of vertices is greater
    {
...
//CHANGE THIS getting latitutde/longatitude and figuring out the distance to get the weight
